...
class MainFraction { // Classe de test de Fraction et contenant la fonction principale
	...
	/* A COMPLETER A PARTIR D'ICI !! */
		Fraction ftest4=new Fraction(360,90);
		Fraction ftest=new Fraction(360,180);
		Fraction ftest1= ftest.fractionReduite();
		System.out.println("ftest = " +ftest.toString());
		System.out.println("ftest1 = " +ftest1.toString());

		Fraction ftest2=ftest.fractionAddition(ftest4);
		Fraction ftest3=ftest.fractionMultiplcation(ftest4);
		System.out.println("ftest2 = " +ftest2.toString());
		System.out.println("ftest3 = " +ftest3.toString());
